...
import { ModalSuccess, Select, Specialist } from "../../features/components";
...
const Appointment = () => {
  ...
  return (
    <div>
      {stat === 1 ? <ModalSuccess text="Make an Appointment" to={"/"} /> : null}
      <main className="py-14">
        <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
          <div className="max-w-lg mx-auto space-y-3 sm:text-center">
            ...
            <p>
              Scheduling an appointment with a healthcare provider is an
              important step in taking control of your health.
            </p>
          </div>
